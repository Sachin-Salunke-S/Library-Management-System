...
connector = sqlite3.connect('SQL/mydb.db')
...
# Right Top Frame
Button(RT_frame, text='Delete Book', font=btn_font, bg=btn_hlb_bg, width=17, command=remove_record).place(x=8, y=30)
Button(RT_frame, text='Del Inventory', font=btn_font, bg=btn_hlb_bg, width=17, command=delete_inventory).place(x=178, y=30)
Button(RT_frame, text='Update BookInfo', font=btn_font, bg=btn_hlb_bg, width=17,
